...
class SpGraphAttentionLayer(nn.Module):
    ...
    def forward(self, input, adj):
        ...
        #erowsum = self.special_spmm(edge, edge_e, torch.Size([N, N]), torch.ones(size=(N, 1), device=dv))
        ...
        e = torch.sparse_coo_tensor(edge, edge_e, torch.Size([N, N]))  # / e_rowsum
        e = e.to_dense()
        # e = e/erowsum
        # print(e)
        Wh_att = e/e_rowsum
