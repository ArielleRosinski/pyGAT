...
class GraphAttentionLayer(nn.Module):
    ...
    """
    def __init__(self, in_features, out_features, dropout, alpha, concat=True, skip_connection = True):
    ...
    def forward(self, h, adj):
        # Dropout on the inputs as mentioned in the paper
        h = F.dropout(h, self.dropout, training=self.training)
        # Linear projection
        Wh = torch.mm(h, self.W) # h.shape: (N, in_features), Wh.shape: (N, out_features)
        # Apply dropout as they did in the official implementation
