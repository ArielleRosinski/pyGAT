...
parser.add_argument('--patience', type=int, default=10, help='Patience') #100
...
for epoch in range(args.epochs):
    ...
    ''''
    new_directory = f'./{args.dataset}'
    os.makedirs(new_directory, exist_ok=True)
    '''
    torch.save(model.state_dict(), '{}_{}_{}.pkl'.format(epoch, args.dataset, args.model))
